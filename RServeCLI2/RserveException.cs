...
/// </summary>
        ...
        private static string ServerErrorCodeDescription(int serverErrorCode)
        {
            ...
            switch (serverErrorCode)
            {
                ...
                case Qap1.ErrAuthFailed:
                    return "authorization failed";
                case Qap1.ErrConnBroken:
                    return "connection closed or broken packet killed it";
                case Qap1.ErrInvCmd:
                    return "unsupported/invalid command";
                case Qap1.ErrInvPar:
                    return "some parameters are invalid";
                case Qap1.ErrRerror:
                    return "R-error occured";
                case Qap1.ErrIoError:
                    return "i/o error (server-side)";
                case Qap1.ErrNotOpen:
                    return "attempt to perform file Read/Write on closed file.";
                case Qap1.ErrAccessDenied:
                    return "access denied (local to the server)";
                case Qap1.ErrUnsupportedCmd:
                    return
                        "unsupported command - known to the server but for some reason (e.g. platform dependent) it's not suported";
                case Qap1.ErrUnknownCmd:
                    return "unknown command - not recognized by server";
                case Qap1.ErrDataOverflow:
                    return "data overflow, incoming data too big";
                case Qap1.ErrObjectTooBig:
                    return "evaluation successful, but returned object is too big to transport";
                case Qap1.ErrOutOfMem:
                    return "server ran out of memory, closing connection";
                case Qap1.ErrCtrlClosed:
                    return "control pipe to the master process is closed or broken";
                case Qap1.ErrSessionBusy:
                    return "session is still busy";
                case Qap1.ErrDetachFailed:
                    return
                        "unable to detach seesion (cannot determine peer IP or problems creating a listening socket for resume)";
                case Qap1.ErrDisabled:
                    return "feature is disabled";
                case Qap1.ErrUnavailable:
                    return "feature is not present in this build";
                case Qap1.ErrCryptError:
                    return "crypto-system error";
                case Qap1.ErrSecurityClose:
                    return
